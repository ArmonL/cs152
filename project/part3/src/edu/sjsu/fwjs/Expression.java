    ...
    public Value evaluate(Environment env) {
        ...
        if (e1.evaluate(env) instanceof IntVal && e2.evaluate(env) instanceof IntVal) {
            ...
            switch (op) {
                ...
                // Consider throwing exception if no match
            }
        }
        return v;
        // This might spawn dragons
    }
}
...
class IfExpr implements Expression {
    ...
    public Value evaluate(Environment env) {
        ...
        if (!(cond.evaluate(env) instanceof BoolVal)) {
...
class FunctionAppExpr implements Expression {
    ...
    public Value evaluate(Environment env) {
        ...
        return ((ClosureVal) f.evaluate(env)).apply(argVals, env);
